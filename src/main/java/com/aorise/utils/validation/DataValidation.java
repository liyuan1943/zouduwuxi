package com.aorise.utils.validation;
...
public class DataValidation {
     ...
     * 非负整数
     */
    private static final String V_ZE_INDEX = "^[0-9]\\d*$";
     ...
     * 身份证
     */
    private static final String V_IDCARD = "^[1-9]\\d{5}(18|19|20|(3\\d))\\d{2}((0[1-9])|(1[0-2]))(([0-2][1-9])|10|20|30|31)\\d{3}[0-9Xx]$";
     ...
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public boolean chekeZE_index(String value, String errorMsg) {
        if (!match(V_ZE_INDEX, value)) {
            throw new DataValidationException(errorMsg);
        }
        return true;
    }
